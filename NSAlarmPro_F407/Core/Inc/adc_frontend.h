...
typedef enum {
    ADC_FRONTEND_IDX_ZONE_BASE = 0,
    ADC_FRONTEND_IDX_VBAT = NSAP_MAX_ZONES,
    ADC_FRONTEND_IDX_TEMP = NSAP_MAX_ZONES + 1,
    ADC_FRONTEND_IDX_VREF = NSAP_MAX_ZONES + 2
} adc_frontend_index_t;
#else
typedef enum {
    ADC_FRONTEND_IDX_ZONE_BASE = 0,
    ADC_FRONTEND_IDX_TAMPER = NSAP_MAX_ZONES,
    ADC_FRONTEND_IDX_VBAT = NSAP_MAX_ZONES + 1,
    ADC_FRONTEND_IDX_TEMP = NSAP_MAX_ZONES + 2,
    ADC_FRONTEND_IDX_VREF = NSAP_MAX_ZONES + 3
} adc_frontend_index_t;
#endif
